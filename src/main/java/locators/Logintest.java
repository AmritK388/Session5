	...
	//	@BeforeClass
		...
		public void init() {
			...
			if (browser.equalsIgnoreCase("chrome")) {
				...
				System.setProperty("webdriver.chrome.driver", "/Users/Amrit/Selenium/Session5/driver/driver/chromedriver");
				driver = new ChromeDriver();

			} else if(browser.equalsIgnoreCase("firefox")){

				System.setProperty("webdriver.gecko.driver", "/Users/Amrit/Selenium/Session5/gecko/geckodriver");
